# E7T1 — SQLite database schema

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 STRKLY

Implement database schema:
1. Users table with telegram_user_id, display_name, timezone
2. Habits table with all required fields
3. Day_records table with habit_id, date, count, done
