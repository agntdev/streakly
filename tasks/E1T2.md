# E1T2 — Timezone selection via inline buttons

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 STRKLY

Create paginated timezone selection during first run:
1. Show searchable list of timezones in pages
2. Store selected timezone in user record
3. Uses inline buttons with callback queries
4. Writes dialog spec to tests/specs/E1T2.json and appends to tests/commands.json
